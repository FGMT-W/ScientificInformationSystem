package com.myproject.scientificinformationsystem.modules.project.controller;
...
public class ProjectController {
    ...
    public SisResult pass(Integer projectId, Integer adminId){
        ...
        Project project;
        if(passService.getPassCount(projectId)==1){
    ...
    SisResult getAdminCount(){
        Map<String,Integer> data=new HashMap<>();
        data.put("shouldThesis",projectService.getAdminShouldThesis());
